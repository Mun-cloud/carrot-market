...
const CommunityPostDetail: NextPage = () => {
  ...
  const onWonderClick = () => {
    if (!data || isLoading || loading) return;
    mutate(
      (prev) =>
        prev && {
          ...prev,
          post: {
            ...
            _count: {
              ...prev?.post._count,
              wonderings: prev?.post._count.wonderings
    ...
    <Layout canGoBack>
      <div>
        ...
        {data?.post?.answers?.map((answer) => (
          <div className="px-4 my-5 space-y-5" key={answer.id}>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <span className="text-xs text-gray-500 block ">
                  {answer.createAt?.toString().slice(0, 10)}
                </span>
